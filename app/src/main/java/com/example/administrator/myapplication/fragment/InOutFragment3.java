...
public class InOutFragment3 extends BaseFragment {
    ...
    protected void initData() {
        ...
        if (MyApplication.get().isDirectly()) {
            status = StatusFactory.STEP_DIRECTLY_LOGINOUT3;
        } else {
            status = StatusFactory.STEP_TURN_LOGINOUT3;
        }
        initExitDialog();
        initTimeFactory();
...
//                }
    ...
    private void setTxtValue() {
        tvTitle.setText(String.format(getResources().getString(R.string.inout_title), "三"));
        tvContent.setText(String.format(getResources().getString(R.string.inout_content), "三"));
    }
        ...
        request.setCallBackListener(new MyCallBack() {
            ...
            public void onSuccess(int what, Object object) {
                ...
                if (helper != null) {
                    ...
                    isOver=helper.isOver();  //是否直连或转发全部完成
