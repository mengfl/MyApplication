...
public class ViewHolder extends RecyclerView.ViewHolder
{
    ...
    /**
     *
     * @param viewId  SimpleDraweeView 的id
     * @param imageUrl
     * @return
     */
    public ViewHolder setImageByUrl(int viewId, String imageUrl)
    {
        ...
        BitmapUtil.showUrl(mContext,view,imageUrl);
        return this;
    }
    public ViewHolder setImageByRes(int viewId, int resId)
    {
        SimpleDraweeView view = getView(viewId);
        BitmapUtil.showRes(view,resId);
        return this;
    }
    public ViewHolder setImageByPath(int viewId, String path)
    {
        SimpleDraweeView view = getView(viewId);
        showPic(view,path);
        return this;
    ...
    public ViewHolder canClickable(int viewId,boolean f)
    {
    ...
    public void showPic(SimpleDraweeView view, String path) {
