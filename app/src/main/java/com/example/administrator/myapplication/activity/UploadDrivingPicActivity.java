 ...
 * 上传图片activity
 */
public class UploadDrivingPicActivity extends AbsBaseTitleActivity {
    ...
    protected void initView() {
        super.initView();
        tvInfo.setText(getString(R.string.uploadpic_driving));
        isUpload=getIntent().getBooleanExtra(ConstantUtil.BUNDLE_KEY_BOOLEAN,false);
        frontFile=new File(ConstantUtil.PATH_PIC,ConstantUtil.NAME_PIC_DRIVING);
        if (isUpload){
            ...
            BitmapUtil.showRes(mSdv,R.drawable.pic_example_driving);
        }
    }
    @Override
    ...
    public void uploadFile(File file) {
        ...
        request.setCallBackListener(new MyCallBack() {
            ...
            public void onSuccess(int what, Object object) {
                ...
                RxBus.getDefault().post(new UploadPicEvent(UploadPicEvent.TYPE_DRIVING,true));
                finish();
            }
