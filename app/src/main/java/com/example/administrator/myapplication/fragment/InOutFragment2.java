...
public class InOutFragment2 extends BaseFragment {
    ...
    protected void initData() {
        ...
        if (MyApplication.get().isDirectly()){
            status=StatusFactory.STEP_DIRECTLY_LOGINOUT2;
        }else {
            status=StatusFactory.STEP_TURN_LOGINOUT2;
        }
        initExitDialog();
        initTimeFactory();
...
//                }
    ...
    private void setTxtValue() {
        tvTitle.setText(String.format(getResources().getString(R.string.inout_title), "二"));
        tvContent.setText(String.format(getResources().getString(R.string.inout_content), "二"));
    }
    ...
    private void testSuccess() {
        ...
        tipsDialog.setOnTipsButtonClick(new TipsDialog.OnTipsButtonClick() {
            @Override
            public void onOkClick() {
                startFragment(InOutFragment3.class);
            }
        });
