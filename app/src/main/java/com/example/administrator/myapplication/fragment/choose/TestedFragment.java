...
public class TestedFragment extends BaseFragment {
    ...
    private void initRecyclerView() {
        mAdapter = new ChooseCarAdapter(getActivity(), R.layout.item_choosetype, mData,true);
    ...
    private void getData() {
        ...
        SearchCheckingCarRequest request = new SearchCheckingCarRequest(getActivity(), NetHelper.URL_SEARCH_CHECKING_CAR);
